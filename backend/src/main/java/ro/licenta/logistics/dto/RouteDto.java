...
public record RouteDto(String vehicleCode, String driverName, DepotDto depot, String kind, double loadKg,
                       double peakLoadKg, double capacityKg, double distanceKm, int drivingMinutes, int serviceMinutes,
                       int breakMinutes, int durationMinutes, int legalMaxDriveMinutes, int dailyRestMinutes,
                       double fuelLiters, double costRon, List<RouteStopDto> stops) {
}
