...
public record SettingsDto(
    ...
    public double vanDailyAmortizationRon() {
        return dailyAmortization(vanPurchasePriceRon);
    }

    public double truckDailyAmortizationRon() {
        return dailyAmortization(truckPurchasePriceRon);
    }

    public double vanResidualValueRon() {
        return vanPurchasePriceRon * residualValuePercent / 100.0;
    }

    public double truckResidualValueRon() {
        return truckPurchasePriceRon * residualValuePercent / 100.0;
    }
