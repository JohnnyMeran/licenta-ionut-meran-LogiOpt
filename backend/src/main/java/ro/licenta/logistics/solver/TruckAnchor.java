...
public class TruckAnchor implements Standstill {
    ...
    public TruckAnchor(String code, String driverName, String depotId, String depotName, Set<String> products,
                       ...
                       int maxDriveMinutes, int breakAfterMinutes, int breakDurationMinutes, double latitude,
        ...
        this.consumptionLPer100Km = consumptionLPer100Km;
        this.costRonPerKm = costRonPerKm;
        this.fixedDailyCostRon = fixedDailyCostRon;
    ...
    public double getCostRonPerKm() {
        return costRonPerKm;
    }

    public double getFixedDailyCostRon() {
        return fixedDailyCostRon;
    }

    public int getMaxDriveMinutes() {
